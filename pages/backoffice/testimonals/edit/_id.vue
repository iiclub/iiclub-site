  ...
  export default {
    ...
    methods:{
      update(){
        ...
        var self = this;
        axios.post("/backoffice/testimonal/update", this.imagesList)
        .then(function (response) {
            console.log(response);
            self.$router.push("/backoffice/testimonals/view");
        })
      ...
      deletethis(){
            var self = this;
            axios.get("/backoffice/testimonal/delete?id="+this.imagesList._id)
            .then(function (response) {
                console.log(response);
                self.$router.push("/backoffice/testimonals/view");
            })
    ...
    created(){
        ...
        var apiUrl = "http://localhost:3000/backoffice/testimonal/editcarousalget";
