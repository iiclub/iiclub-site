...
export default {
    ...
    asyncData (context) {
        ...
        var baseurl = "http://localhost:3000/backoffice/workshop/view";
    ...
    methods:{
        triggerEdit(id){
            ...
            this.$router.push("/backoffice/workshop/editworkshop/"+id);
        },
        addImage(id){
            console.log( " addImage id ",id); 
            this.$router.push("/backoffice/workshop/addimage/"+id);
        }
    },
    layout: "backoffice"
}
