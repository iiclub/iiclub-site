...
data(){
  ...
  asyncData (context) {
        ...
        var baseurl = "http://localhost:3000/backoffice/training/view";
    ...
    methods:{
        triggerEdit(id){
            ...
            this.$router.push("/backoffice/training/edittraining/"+id);
        },
        addImage(id){
            console.log( " addImage id ",id); 
            this.$router.push("/backoffice/training/addimage/"+id);
        }
    }
}
</script>
