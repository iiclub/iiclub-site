  ...
  export default {
    ...
    methods:{
      ...
      update(){
        ...
        var self = this;
         axios.post("/backoffice/training/edit", data)
      ...
      deletethis(){
          console.log("in delete() this.id ",this.id);
            var self = this;
            axios.get("/backoffice/training/delete?id="+this.id).then((res) =>{
                console.log("res sucess ");
                var content = res.data;
                if(content.response == "success"){
                    console.log("response success data ",content.data);
                    self.$router.push("/backoffice/training/viewtraining");
                }
                else{
      ...
      deleteImage(imageId){
            ...
            axios.get("/backoffice/training/deleteimage?id="+this.id+"&imageid="+imageId).then((res) =>{
                console.log("res sucess ");
                var content = res.data;
                if(content.response == "success"){
                    console.log("response success data ",content.data);
