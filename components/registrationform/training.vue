        ...
        <v-flex xs12 md6 offset-md3>
          <v-card color="green">
            <v-toolbar color="indigo" class="toolbar-custom">
              <v-toolbar-title>Training Registration</v-toolbar-title>
            </v-toolbar>
            <v-card-text>
  ...
  methods:{
    ...
    register1(){
      this.loader = 'loading4';
       ...
       var apiUrl = "/frontoffice/training/register";
        var dataInput = {
          id : this.id,
     ...
     created(){
        console.log("in training details created component",this.urlparam);
        var apiUrl = "/frontoffice/training/details/"+this.urlparam;
        this.$axios.$get(apiUrl).then((res) =>{
            //var content = res.data.data;
            var content = res.data;
            console.log("content " ,content)
            this.id = content.id;
            this.trainingname = content.name;
